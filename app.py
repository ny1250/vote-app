...
# 팀 정보
teams_data = [
    {"id": "1조(범준이 지각 그만해)", "name": "인계템", "desc": "사람별 연락주기 관리 시스템", "emoji": "📊"},
    {"id": "2조", "name": "소마고 상식 퀴즈", "desc": "소마고 상식퀴즈", "emoji": "🧠"},
    {"id": "3조(코드밸런스)", "name": "개인 지출 관리 프로그램", "desc": "지출관리", "emoji": "✅"},
    {"id": "4조(부마민국)", "name": "무비픽", "desc": "영화추천 프로그램", "emoji": "🎬"},
    {"id": "5조(오억오조)", "name": "미게한민족", "desc": "미니게임", "emoji": "🎮"},
    {"id": "6조(6조판서)", "name": "Today Fortune", "desc": "오늘의 운세", "emoji": "🔮"},
    {"id": "7조", "name": "해주세요", "desc": "해주세요/도와줄게요", "emoji": "🙋🏻"},
    {"id": "8조(최강거북이)", "name": "거북이의 여행", "desc": "도박 베팅은 몸에 안좋아요", "emoji": "🐢"},
    {"id": "9조(임효재)", "name": "급식알리미", "desc": "급식메뉴검색", "emoji": "🍽️"},
    {"id": "10조", "name": "3분 MBTI", "desc": "성격 유형 분석", "emoji": "🧠"},
]
